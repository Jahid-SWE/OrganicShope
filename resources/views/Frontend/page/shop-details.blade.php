                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            <img data-imgbigurl="{{ asset('/') }}/Frontend/img/product/details/product-details-2.jpg" src="{{ asset('/') }}/Frontend/img/product/details/thumb-1.jpg" alt="">
                            <img data-imgbigurl="{{ asset('/') }}/Frontend/img/product/details/product-details-3.jpg" src="{{ asset('/') }}/Frontend/img/product/details/thumb-2.jpg" alt="">
                            <img data-imgbigurl="{{ asset('/') }}/Frontend/img/product/details/product-details-5.jpg" src="{{ asset('/') }}/Frontend/img/product/details/thumb-3.jpg" alt="">
                            <img data-imgbigurl="{{ asset('/') }}/Frontend/img/product/details/product-details-4.jpg" src="{{ asset('/') }}/Frontend/img/product/details/thumb-4.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
